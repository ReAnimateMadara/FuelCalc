...
@app.route('/calculate_fuelA320neo', methods=['POST'])
def calculate_fuelA320neo():
    ...
    try:
        if ((ZFW >= 44220 and ZFW <= 64300) and altitude <= 39100):
...
def calculate_fuelB738():
    ...
    try:
        if ((ZFW < 43111 and ZFW > 62731) and altitude < 41100):
            if (distance >= 100 and distance <= 2000):
